 ...
 * @endcode
 */
$settings['hash_salt'] = 't4S7yw6ttrt1wDOhdVVGjhW8aZ962kevnRSBEpa79le5LSpREZpXESTDmSz-X-FaJ-A5nUiSXg';
 ...
 * Set up Split config
 */
if (getenv('ENV_NAME') === 'DEV') {
  $config['config_split.config_split.dev']['status'] = TRUE;
  $config['config_split.config_split.recette']['status'] = FALSE;
  $config['config_split.config_split.prod']['status'] = FALSE;
}elseif (getenv('ENV_NAME') === 'RECETTE') {
  $config['config_split.config_split.dev']['status'] = FALSE;
  $config['config_split.config_split.recette']['status'] = TRUE;
  $config['config_split.config_split.prod']['status'] = FALSE;
}elseif (getenv('ENV_NAME') === 'PROD') {
  $config['config_split.config_split.dev']['status'] = FALSE;
  $config['config_split.config_split.recette']['status'] = FALSE;
